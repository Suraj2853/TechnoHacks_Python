...
pass_label = tk.Label(root, text='PASSWORD LENGTH', font=('Times New Roman', 12, 'bold'), bg="lightgreen", fg = 'blue')
...
app_label = tk.Label(root, text='Suraj Mishra', font=('Times New Roman', 20, 'bold'), fg='Red' ,bg = 'lightgreen')
