...
root.geometry("630x630+0+0")
root.resizable(0, 0)
root.config(bg="#CDFAD5")

# Define images
Blank_img = PhotoImage(file="Task 3 - Rock,Paper,Scissors Game/images/blank.png")
Player_Rock = PhotoImage(file="Task 3 - Rock,Paper,Scissors Game/images/rock_player.png")
Player_Rock_ado = Player_Rock.subsample(3, 3)
Player_Paper = PhotoImage(file="Task 3 - Rock,Paper,Scissors Game/images/paper_player.png")
Player_Paper_ado = Player_Paper.subsample(3, 3)
Player_Scissor = PhotoImage(file="Task 3 - Rock,Paper,Scissors Game/images/scissor_player.png")
Player_Scissor_ado = Player_Scissor.subsample(3, 3)
Computer_Rock = PhotoImage(file="Task 3 - Rock,Paper,Scissors Game/images/rock_computer.png")
Computer_Paper = PhotoImage(file="Task 3 - Rock,Paper,Scissors Game/images/paper_computer.png")
Computer_Scissor = PhotoImage(file="Task 3 - Rock,Paper,Scissors Game/images/scissor_computer.png")
...
Label_Player = Label(root, text="PLAYER", font=('Arial', 19, 'bold'), bg="#4CB9E7", fg="black")
Label_Player.grid(row=1, column=1)
Label_Computer = Label(root, text="COMPUTER", font=('Arial', 19, 'bold'), bg="#4CB9E7", fg="black")
